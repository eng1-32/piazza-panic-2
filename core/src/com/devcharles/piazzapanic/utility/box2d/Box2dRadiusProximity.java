...
/**
 * A {@code Box2dRadiusProximity} is a {@link Proximity} that queries the world for all fixtures
 * that potentially overlap the circle having the specified detection radius and whose center is the
 * owner position.
 *
 * @author davebaol
 */
