...
public class LightBuilder {
   ...
   */
  public static PointLight createPointLight(RayHandler rayHandler, float x, float y, Color c,
      float dist,
      boolean soft) {
   ...
   * @return {@link PointLight} reference.
   */
  public static PointLight createRoomLight(RayHandler rayHandler, float x, float y, Color c,
      float dist,
      boolean xray) {
    PointLight pl = new PointLight(rayHandler, rays, c, dist, x, y);
    pl.setContactFilter(CollisionCategory.LIGHTS.getValue(), (short) 0,
