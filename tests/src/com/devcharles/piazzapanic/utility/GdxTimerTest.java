...
public class GdxTimerTest {
  ...
  public void tickTestElapsedGreater() {
    ...
    int incrementOriginalTime = spawnTimer.getElapsed() + 1000;
    spawnTimer.tick(31);
    assertEquals("Expect timer to reset after 30s then continue.", incrementOriginalTime,
        spawnTimer.getElapsed());
  }
  ...
  public void tickTestDeltaSmall() {
    ...
    assertEquals("Expect timer to increase by a small amount.", incrementOriginalTime,
        spawnTimer.getElapsed());
  }
  ...
  public void tickTestDeltaLarge() {
    ...
    assertEquals("Expect timer to increase by large amount while resetting to 0 after 30s.",
        incrementOriginalTime, spawnTimer.getElapsed());
  }
