...
public class WalkAnimatorTest {
  ...
  public void rotationToDirectionTest() {
    ...
    assertEquals("Direction should be left after rounding up.", Direction.left,
        rotationToDirection(158));
    assertEquals("Direction should be up after rounding down.", Direction.up,
        rotationToDirection(157));
  }
}
